...
const RULES: [ParseRule; 40] = [
    ...
    define!{EqualEqual  , None          , None        , Precedence::None  },
    define!{Less        , None          , None        , Precedence::None  },
    define!{LessEqual   , None          , None        , Precedence::None  },
    define!{Greater     , None          , None        , Precedence::None  },
    define!{GreaterEqual, None          , None        , Precedence::None  },
    define!{Bang        , None          , None        , Precedence::None  },
    define!{BangEqual   , None          , None        , Precedence::None  },
    ...
    define!{True        , None          , None        , Precedence::None  },
    define!{False       , None          , None        , Precedence::None  },
    ...
    define!{Nil         , None          , None        , Precedence::None  },
